...
const cardCva = cva("overflow-hidden", {
  variants: {
    ...
    border: {
      ...
      secondary: "border-2 bg-gray-500",
      success: "border-2 bg-green-500",
      danger: "border-2 bg-red-500",
      warning: "border-2 bg-yellow-500",
      info: "border-2 bg-sky-500",
      dark: "border-2 bg-black",
      light: "border-2 bg-zinc-100",
    },
    text: {
