...
interface DarkModeProps extends React.HTMLAttributes<HTMLButtonElement> {}

export const NavbarDarkMode: React.FC<DarkModeProps> = ({ className }) => {
...
NavbarDarkMode.displayName = "Navbar.Darkmode";
