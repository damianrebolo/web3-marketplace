...
export const Pagination: React.FC<Props> = memo(
  ({ pageIndex, rowsLength, pageSize, canPreviousPage, canNextPage, previousPage, nextPage }) => (
    <div className="flex flex-col items-center">
      <span className="text-sm text-gray-700 dark:text-gray-400">
        ...
        <span className="font-semibold text-gray-900 dark:text-white">{rowsLength}</span>
      </span>
